...
namespace Model {
    public static class Import {
        public static void DBImport () {
            Student estudante1 = new Student("Kaique Augusto Benedito da Paz", "Email@email.com.br", 5);
            ...
            Book livro1 = new Book("Machado de Assis", "Penguin", Convert.ToDateTime ("01/01/1984"));
            // new Book ("Machado de Assis", "Penguin Companhia", Convert.ToDateTime ("14/02/1989"));
            ...
            // Rent locacao = new Rent(estudante1, Convert.ToDateTime ("21/03/2021"), livro1);
